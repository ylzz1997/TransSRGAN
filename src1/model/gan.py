...
parser.add_argument('--batch_size', type=int, default=10, help='training batch size for each epoch')
...
parser.add_argument('--gradclip', type=int, default=15, help='Gradient Clipping')
