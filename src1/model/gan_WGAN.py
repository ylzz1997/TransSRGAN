...
parser.add_argument('--model_dump_path', type=str, default='../../resource/Wgan_models', help='model\'s save path')
parser.add_argument('--verbose', type=bool, default=True, help='output verbose messages')
parser.add_argument('--tmp_path', type=str, default='../../resource/W_training_temp/', help='path of the intermediate files during training')
parser.add_argument('--verbose_T', type=int, default=100, help='steps for saving intermediate file')
parser.add_argument('--logfile', type=str, default='../../resource/wtraining.log', help='logging path')
...
def clip_network_weights(element):
  for name, param in element.named_parameters():
    param.clamp(-gradclip,gradclip)
  ...
  def train(self):
    ...
    while self.epoch <= max_epoch:
      ...
      for i, (avatar_tag, avatar_img) in enumerate(self.data_loader):
        ...
        self.D.apply(clip_network_weights)
        # 2. Training G
